export default function Account() {
    return (
        <>
            <div className="flex text-xs px-[70px] h-[100px] items-center justify-between">
                <div>
            ...
            <div className="sm:flex justify-evenly">
                <div className="w-[30%] lg:pl-[70px] mx-auto sm:pl-5">
                ...
                <div className="w-[70%] my-10 sm:p-10 text-[13px] sm:text-base sm:mx-10 mx-auto  py-6 px-4 shadow-lg ">
                    ...
                    <div className="my-3">
                        ...
                        <input type="password" className=" bg-[#F5F5F5] mb-3  w-[300px] lg:w-[650px] xl:w-[700px] 
