...
export default function BestSelling() {
    ...
    return (
        <main className="mt-10">
            <div className="">
                <h1 className="md:text-lg text-[12px] text-[#DB4444] font-bold">This Month</h1>
                <div className="flex justify-between">
                    <h1 className="text-[12px] md:text-5xl font-bold">Best Selling Product</h1>

                    <div className="flex justify-center -mt-5 mb-4">
                        <button className="text-white bg-red-500 text-sm md:text-lg px-4 py-3 md:px-10 md:py-4 rounded-xl">View All</button>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-black p-6 sm:p-16">
                <div className="text-center sm:text-left">
                    ...
                    <div className="mt-5 sm:mt-10">
                        <button className="text-white bg-[#00FF66] px-2 py-3 md:px-10 md:py-4 rounded-lg">View All Products</button>
                    </div>
                </div>
                <div className="p-4">
                    <Image
